...
export default function Team() {
    return (
        <section id="team" className="py-24 px-6 relative overflow-hidden bg-black">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {teamMembers.map((member, i) => (
                        <motion.div
                            ...
                            className="glass p-8 rounded-2xl border border-white/5 transition-colors group relative overflow-hidden flex flex-col"
                        >
                            <motion.div
                            ...
                            <div className="relative w-24 h-24 mb-6">
                                ...
                                >
                                    {member.image ? (
                                        ...
                                        <User className="w-12 h-12 text-neon-blue/50" />
                                    )}
                                </motion.div>
                            </div>
                            ...
                            <motion.h3
                                ...
                                className="text-xl font-bold mb-1 text-white transition-colors"
                            >
                                {member.name}
                            </motion.h3>
                            <p className="text-neon-blue text-xs font-bold uppercase tracking-wider mb-4">{member.role}</p>
                            ...
                            <div className="pt-4 border-t border-white/5">
                                <p className="text-gray-400 text-xs font-medium">{member.degree}</p>
                                <p className="text-gray-500 text-[10px] mt-1 uppercase tracking-widest">{member.year}</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
