...
export default function Future() {
    return (
        <section id="future" className="relative min-h-[100dvh] w-full flex items-center justify-center overflow-hidden bg-black py-20">
            ...
            <div className="relative z-10 text-center max-w-4xl px-6">
                ...
                >
                    <span className="inline-block py-1 px-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20 text-[10px] sm:text-xs font-bold tracking-[0.3em] uppercase mb-8">
                        Vision 2030
                    </span>

                    <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                        Imagine smart cities where <br className="hidden sm:block" />
                    ...
                    <div className="space-y-4 text-base sm:text-xl text-gray-300 max-w-2xl mx-auto mb-10">
                        ...
                        <p className="italic text-gray-400 mt-8 text-sm sm:text-lg">
